<template>
    <footer
        class="px-2 flex justify-between font-medium text-xxs text-neutral-400 bg-neutral-600"
    >
        <div
        ...
        <div
            class="class-helper w-1/4 w-1/5 w-1/6 w-1/7 w-1/8 w-1/9 w-1/10 hover:bg-primary-500 hidden"
        ></div>
    </footer>
</template>
