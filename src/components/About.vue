<template>
    ...
    >
        <p>
            ...
            <span
                class="underline text-black font-extrabold cursor-pointer hover:text-neutral-600"
        ...
        <transition name="fade">
            ...
            >
                ...
                <p class="w-full default">
                    Write your feedback below. Please specify a bit if you
                    encounter a bug. Thanks!
                </p>
                <input
                ...
                <transition name="fade">
                    <div v-if="errors.length" class="text-xs text-red-700">
