<template>
    <aside v-if="!pathToLibrary" class="w-full h-full relative flex">
        <img
        ...
        />
        <div
            class="z-10 w-full text-white flex flex-col items-center justify-center"
        >
            <img
            ...
            <div class="mt-5 max-w-prose text-center text-white font-medium">
                <p>A tool build by Sefrijn to help you manage your library.</p>
            </div>
            <div
                v-if="sent"
            ...
            >
                ...
                <div class="flex space-x-3">
                    <input
                        class="bg-primary-500 hover:bg-primary-600 font-bold tracking-wider text-white px-2.5 py-1 cursor-pointer"
                        type="submit"
                        value="Send"
                    />
                    <button
...
.fade-enter-primary-500,
.fade-leave-primary-500 {
    transition: opacity 0.5s;
}
.fade-enter, .fade-leave-to /* .fade-leave-primary-500 below version 2.1.8 */ {
    opacity: 0;
}
